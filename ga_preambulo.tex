...
%\documentclass[10pt,spanish,a5paper,twoside=true]{scrbook} %impresión en a5
...
\newcommand*\varhrulefill[1][1pc]{\leavevmode\leaders\hrule height#1\hfill\kern0pt \vspace{1pc}} % --- "reglas" de capítulos

\newcommand{\capitulo}[1]{\chapter{#1} \varhrulefill} % --- redifinición de capítulos
